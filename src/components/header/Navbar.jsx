  ...
  const [products, setProducts] = useState([]);
    ...
    useEffect(function() {
      ...
      async function fetchUser() {
        try {
          const res = await axios.get("https://amazon-clone-sp-be.herokuapp.com/api/getAuthUser", {
      ...
      async function fetchProducts() {
        const res = await axios.get("https://amazon-clone-sp-be.herokuapp.com/api/products");
    ...
    // Logout 
      function logout() {
        try {
          const res = axios.get("https://amazon-clone-sp-be.herokuapp.com/api/logout", {
            withCredentials: true
          })
